import type { AdminNewsMeta } from '../../../types/news';
...
export function AdminNewsPagination({ meta, onPageChange }: Props) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '0.75rem' }}>
        ...
        >
          {tAdminNews('pagination.previous', language)}
        </button>
        <button
          type="button"
          onClick={handleNext}
        ...
        >
          {tAdminNews('pagination.next', language)}
        </button>
      </div>
    </div>
  );
