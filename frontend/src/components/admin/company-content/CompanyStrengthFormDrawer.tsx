...
interface CompanyStrengthFormDrawerProps {
  open: boolean;
  mode: 'create' | 'edit';
...
export function CompanyStrengthFormDrawer({
  open,
  mode,
  strength,
  ...
  deleting = false,
  onPresignImage,
}: CompanyStrengthFormDrawerProps) {
  ...
  useEffect(() => {
    if (open && strength && mode === 'edit') {
      setValues({
        titleAr: strength.titleAr,
        titleEn: strength.titleEn,
        descriptionAr: strength.descriptionAr,
        descriptionEn: strength.descriptionEn,
