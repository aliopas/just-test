...
const messages: Record<InvestorLanguage, MessageDictionary> = {
  ...
  ar: {
    ...
    'status.empty':
      'ملفك الشخصي يبدو فارغًا. أكمل بياناتك للاستفادة من جميع المزايا.',
    'status.error':
      'حدث خطأ أثناء تحميل الملف الشخصي. حاول مرة أخرى لاحقًا.',
    'status.noChanges': 'لم يتم رصد أي تغييرات',
    'toast.saved': 'تم تحديث الملف الشخصي بنجاح',
    'toast.error': 'تعذر تحديث الملف الشخصي',
    'toast.uploadPlaceholder':
      'سيتم تفعيل رفع الوثائق قريبًا ضمن الإصدار القادم.',
