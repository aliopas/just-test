...
- **Decision Actions:** أزرار (قبول، رفض) تستدعي واجهات Story 4.4 مع ملاحظات داخلية اختيارية وتغذية راجعة فورية؛ زر طلب المعلومات يسمح بإرسال رسالة إلزامية للمستثمر (Story 4.5) وينقل الحالة إلى Pending Info.
