...
BEGIN
  ...
  ELSE
    ALTER TABLE projects
      ...
      ADD COLUMN IF NOT EXISTS operating_costs DECIMAL(15, 2),
      ADD COLUMN IF NOT EXISTS annual_benefits DECIMAL(15, 2),
      ADD COLUMN IF NOT EXISTS total_shares INTEGER,
      ADD COLUMN IF NOT EXISTS share_price DECIMAL(15, 2),
